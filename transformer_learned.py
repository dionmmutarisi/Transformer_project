"""
transformer_learned.py — Learned positional embeddings
Assignment 3B baseline model.

Usage:
    python transformer_learned.py --mode toy
    python transformer_learned.py --mode wp --emb 512 --heads 8
    python transformer_learned.py --mode tune --n-trials 30
"""
...
if __name__ == "__main__":
    ...
    if args.mode == "tune":
        ...
        run_name = args.wandb_name or f"learned-{args.mode}"
